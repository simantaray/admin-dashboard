...
export default function Sidebar({displaySide}) {
  ...
  return (
    <div className={` absolute xl:left-[-0px] md:left-[-250px] ${displaySide && "md:left-[0px]"} w-60 h-[calc(100vh-80px)] shadow-md bg-white px-1 absolute  trasition ease-in-out duration-100 z-50`}>
      <div>
